...
public class PDFGenerator {
    ...
    public ByteArrayInputStream createReport(List<SimpleEntity> customers) {
        ...
        try {
            ...
            for (SimpleEntity customer : customers) {
                ...
                PdfPCell lastNameCell = new PdfPCell(new Phrase(customer.getSurname()));
